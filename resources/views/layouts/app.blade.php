...
<nav class="sidebar">
    ...
    <ul class="nav flex-column mt-2">
        ...
        @if(auth()->user()->isOwner())
            ...
            <li><a href="{{ route('owner.history') }}" class="nav-link {{ request()->routeIs('owner.history') ? 'active' : '' }}">
            ...
            <li><a href="{{ route('owner.complaints') }}" class="nav-link {{ request()->routeIs('owner.complaints') ? 'active' : '' }}">
